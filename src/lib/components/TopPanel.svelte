...
>
	...
	<div class="flex items-center space-x-3">
		...
		<div class="flex items-center space-x-1">
			{#each workspaces as workspace}
				<button
					...
					style="
						background: {workspace === activeWorkspace ? 'var(--omarchy-iris)' : 'var(--omarchy-surface)'};
						color: {workspace === activeWorkspace ? 'var(--omarchy-bg)' : 'var(--omarchy-muted)'};
						border: 1px solid {workspace === activeWorkspace ? 'var(--omarchy-iris)' : 'var(--omarchy-overlay)'};
					"
		...
		<!-- Separator -->
		<div class="w-px h-6 bg-gray-600" style="background: var(--omarchy-overlay);"></div>
		...
		<div class="flex items-center space-x-2">
			{#each quickLaunchApps as app}
				<button
					...
					style="background: {app.active ? 'var(--omarchy-highlight-med)' : 'transparent'};"
	...
	<div class="flex items-center space-x-4">
		...
		<div class="flex items-center space-x-3 text-xs">
			...
			<div class="flex items-center space-x-1">
				<div class="flex items-center space-x-0.5">
					<div class="w-1 h-3 bg-green-400 rounded-sm" style="background: var(--omarchy-foam);"></div>
					<div class="w-1 h-4 bg-green-400 rounded-sm" style="background: var(--omarchy-foam);"></div>
					<div class="w-1 h-2 bg-gray-600 rounded-sm" style="background: var(--omarchy-muted);"></div>
					<div class="w-1 h-1 bg-gray-600 rounded-sm" style="background: var(--omarchy-muted);"></div>
				</div>
				<span class="text-gray-400" style="color: var(--omarchy-subtle);">42%</span>
			</div>

			<!-- Memory Usage -->
			<div class="flex items-center space-x-1">
				<div class="w-6 h-1.5 bg-gray-700 rounded-full overflow-hidden" style="background: var(--omarchy-overlay);">
					<div
						class="h-full bg-yellow-400 rounded-full"
						style="width: 65%; background: var(--omarchy-gold);"
					></div>
				</div>
				<span class="text-gray-400" style="color: var(--omarchy-subtle);">6.2G</span>
			</div>
		</div>
		...
		>
			<div class="relative w-6 h-3 border border-current rounded-sm">
				<div class="absolute right-0 top-1/2 transform -translate-y-1/2 w-0.5 h-1 bg-current rounded-r"></div>
				<div
